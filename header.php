...
<title>Rashed EMS for OLLYO</title>
<!-- meta tags -->
		...
		<nav class="navbar navbar-default">
			<div class="container">
				...
				<button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
					<span class="sr-only">Rashed EMS Menu</span>
				...
				<div class="header-right">
					<div class="agileits-topnav">
						<ul>
							<li><span class="glyphicon glyphicon-earphone"></span> +8801771087871</li>
							<li><a class="email-link" href="mailto:example@mail.com"> <span class="glyphicon glyphicon-envelope"></span> rashedulalam711@gmail.com </a></li>
