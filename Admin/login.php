...
<body>
	...
	<div class="header">
		<nav class="navbar navbar-default">
			<div class="container">
				...
				<!-- navigation--> 
					<span class="sr-only">Rashed EMS </span>
	...
	<div class="footer">
		<div class="container">
			<h3 class="w3ltitle"><span>Rashed</span> EMS</h3>
	...
	<div class="footer">
		...
		<div class="copy-right w3-agile-text">
			<div class="container">
				...
				<p>© 2025 Rashed EMS, ALL Rights Preserved, Designed by Rashed </p>
			</div>
		</div>
		<!-- //copy-right -->
	</div>
