	...
	<div class="features">
		<div class="container">
			<div class="col-md-4 feature-grids">
				...
				<p> Rashed EMs,a dynamic event management compnay, which positions itself as "One-Stop Solutions" for all event needs. At Classic Events,we strive to be the most reliable and creative provider of a wide range of services to the clients.</p>
				<p>	Rashed EMS is one of the leading corporate event management companies in india.</p>
				<div class="w3ls-more">
			...
			<div class="col-md-4 feature-grids">
				...
				<div class="w3ls-pince">
					...
					<div class="pince-right">
						...
						<p>Rashed EMS offers comprehensive wedding planning solutions.</p>
					</div>
